...
export default function App() {
  ...
  const renderPage = () => {
    switch (active) {
      ...
      case "Settings":   return <Settings   orgSettings={orgSettings} setOrgSettings={saveOrgSettings} />;
      default:           return null;
    }
  };
  ...
  return (
    <div style={S.app}>
      <Sidebar active={active} setActive={setActive} orgName={orgSettings.name} />
